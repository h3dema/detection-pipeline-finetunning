"""
Faster RCNN model with the EfficientNetB1 backbone.
"""
import torchvision
...
def create_model(num_classes, pretrained=True, coco_model=False):
    """
    Create a Faster RCNN model with the EfficientNetB1 backbone.
    ...
    """
    # Load the pretrained EfficientNetB1 large features.
    backbone = EfficientnetBackbone("b1")
