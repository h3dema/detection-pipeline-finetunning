"""
Faster RCNN model with the EfficientNetB2 backbone.
"""
import torchvision
...
def create_model(num_classes, pretrained=True, coco_model=False):
    """
    Create a Faster RCNN model with the EfficientNetB2 backbone.
    ...
    """
    # Load the pretrained EfficientNetB2 large features.
    backbone = EfficientnetBackbone("b2")
