...
__all__ = [
    ...
    'fasterrcnn_efficientnet_b1',
    'fasterrcnn_efficientnet_b2',
    'fasterrcnn_efficientnet_b3',
    'fasterrcnn_efficientnet_b4',
    'fasterrcnn_efficientnet_b5',
    'fasterrcnn_efficientnet_b6',
    'fasterrcnn_efficientnet_b7',
