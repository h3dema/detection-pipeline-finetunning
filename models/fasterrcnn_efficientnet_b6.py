"""
Faster RCNN model with the EfficientNetB6 backbone.
"""
import torchvision
...
def create_model(num_classes, pretrained=True, coco_model=False):
    """
    Create a Faster RCNN model with the EfficientNetB6 backbone.
    ...
    """
    # Load the pretrained EfficientNetB6 large features.
    backbone = EfficientnetBackbone("b6")
